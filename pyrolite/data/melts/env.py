...
MELTS_environment_variables = {# Solution Models
    ...
    'MODE': mvar(validate=lambda x: x in ['geothermal',
                                         'isenthalpic',
                                         'isentropic',
                                         'isobaric',
                                         'isochoric',
    ...
    'HK_PXGT_TRACE_H2O': mvar(default='mineral-melt',
                              type=bool,
                              validator=lambda x: x in ['mineral-melt',
                                                        'mineral-mineral'],
                              desc=description(
