...
fmts = ["svg", "png", "jpg"]
save_figure(fig, name="icon_all", save_at=save_at, save_fmts=fmts, dpi=dpi)
...
save_axes(ax[2], name="icon_contours", save_at=save_at, save_fmts=fmts, dpi=dpi)
save_axes(ax[3], name="icon_density", save_at=save_at, save_fmts=fmts, dpi=dpi)
