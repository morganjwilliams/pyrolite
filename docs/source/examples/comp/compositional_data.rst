.. note::
    ...
    Click :ref:`here <sphx_glr_download_examples_comp_compositional_data.py>` to download the full example code or run this example in your browser via Binder
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  26.872 seconds)
