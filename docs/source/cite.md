...
:::{note}
{mod}`pyrolite` began as a personal project, but as the project develops
there are likely to be other contributors. Check the
[Contributors list](./dev/contributors.md) and add major contributors as
authors. A [CITATION.cff file](https://github.com/morganjwilliams/pyrolite/blob/main/CITATION.cff)
...
> [doi:10.5281/zenodo.2545106](https://dx.doi.org/doi:10.5281/zenodo.2545106)
...
> doi: [10.1007/s11004-021-09959-5](https://doi.org/10.1007/s11004-021-09959-5)
