...
- **PR Merged**: [Jiawei Yun](https://github.com/louisyuncc) contributed a PR to
  ...
  [#109](https://github.com/morganjwilliams/pyrolite/pull/109).
- **Docs**: Expanded the tutorial on creating plot templates [in the documentation](https://pyrolite.readthedocs.io/en/develop/tutorials/templates.md)..
- **Docs**: Added citations and DOIs for reference composition descriptions
  [in the documentation](https://pyrolite.readthedocs.io/en/develop/data/refcomp.md#composition-list).
- **Docs**: Expanded the lattice strain example to include an
  [example of fitting a profile](https://pyrolite.readthedocs.io/en/develop/examples/geochem/mineral_lattice.md#fitting-lattice-strain-models),
...
- **Docs**: Expanded documentation around labelling schemes and selection of regions to plot for plot templates with an
  [additional section on the relevant page](https://pyrolite.readthedocs.io/en/develop/examples/plotting/templates.md#customization-labelling-schemes-and-field-subsets).
...
- **Bugfix**: Updated use of style file and built-in defaults to avoid hardcoding style ([#107](https://github.com/morganjwilliams/pyrolite/issues/107)).
...
- Updated the feldspar ternary diagram orientation to fit convention as per DHZ ([#108](https://github.com/morganjwilliams/pyrolite/issues/108)).
...
- **PR Merged**: [Sarah Shi](https://github.com/sarashi) contributed a PR to
  ...
  [#104](https://github.com/morganjwilliams/pyrolite/pull/104)).
...
- **New Contributor**: [Malte Mues](https://github.com/mmuesly)
- **New Contributor**: [Bob Myhill](https://github.com/bobmyhill)
...
- **PR Merged**: [Malte Mues](https://github.com/mmuesly) contributed a PR to
  ...
  [#100](https://github.com/morganjwilliams/pyrolite/pull/100)).
  ...
  usage with [pandarallel](https://github.com/nalepae/pandarallel)).
...
- **PR Merged**: [Bob Myhill](https://github.com/bobmyhill) contributed a series of
  pull requests to fix formatting of TAS diagram labels
  ([#91](https://github.com/morganjwilliams/pyrolite/pull/91)),
  update the TAS field names in the JSON template
  ([#92](https://github.com/morganjwilliams/pyrolite/pull/92)),
  improve the formatting and scaling of TAS diagrams
  ([#93](https://github.com/morganjwilliams/pyrolite/pull/93)),
  add an option to add field labels in the visual centre of polygons (rather than the
  'centroid'; [#94](https://github.com/morganjwilliams/pyrolite/pull/94)),
  update some usage of {mod}`matplotlib`
  ([#96](https://github.com/morganjwilliams/pyrolite/pull/96)),
  and allow selective plotting of individual fields when adding a classification
  diagram to axes ([#98](https://github.com/morganjwilliams/pyrolite/pull/98)).
...
- **Bugfix**: [Tom Buckle](https://github.com/bomtuckle) contributed a PR with
  some minor bugfixes for the CIPW Norm
  ([#87](https://github.com/morganjwilliams/pyrolite/pull/87)).
- Various maintenance updates, including migrating the package to use `pyproject.toml`.

## [0.3.3]

- **New Contributor**: [Sarah Shi](https://github.com/sarahshi)
- **New Contributor**: [Ondrej Lexa](https://github.com/ondrolexa)
...
- **PR Merged**: Added an option to get expanded outputs for the CIPW Norm
  (from [Tom Buckle](https://github.com/bomtuckle);
  [#80](https://github.com/morganjwilliams/pyrolite/pull/80)).
- **Bugfix**: Fixes and updated tests for CIPW Norm outputs.

### {mod}`pyrolite.plot`

- **PR Merged**: [Sarah Shi](https://github.com/sarahshi) contributed a PR to add
  variations on the TAS diagram from Le Maitre (
  [#79](https://github.com/morganjwilliams/pyrolite/pull/79)).
...
- **PR Merged**: [Ondrej Lexa](https://github.com/ondrolexa) contributed a PR to add
  ...
  [#82](https://github.com/morganjwilliams/pyrolite/pull/82)).
...
- **New Contributor**: [Angela Rodrigues](https://github.com/AngRodrigues)
...
- **PR Merged**: [Louise Schoneveld](https://github.com/lavender22) submitted
...
- **PR Merged**: [Angela Rodrigues](https://github.com/AngRodrigues) submitted
...
- **New Contributor**: [Martin Bentley](https://github.com/mtb-za)
- **New Contributor**: [Chetan Nathwani](https://github.com/ChetanNathwani)
- **New Contributor**: [Tom Buckle](https://github.com/bomtuckle)
- **New Contributor**: [Nicolas Piette-Lauziere](https://github.com/NicolasPietteLauziere)
- Removed a redundant {mod}`pathlib` dependency (which is standard library as of
  ...
  recipe ([#51](https://github.com/morganjwilliams/pyrolite/issues/51)).
...
- **Bugfix**: Updated use of {mod}`tinydb` databases to default to read-only access except
  ...
  [#61](https://github.com/morganjwilliams/pyrslite/issues/61)). Thanks to
  [Antoine Ouellet](https://github.com/antoine-gs) for bringing this to attention,
  and both Sam Bradley and Alex Hunt for following up with the idea for the
  current solution.

### {mod}`pyrolite.geochem`

- **Feature**: [Nicolas Piette-Lauziere](https://github.com/NicolasPietteLauziere)
...
- **Bugfix**: Modified a few of the {class}`pyrolite.geochem.pyrochem` methods
  ...
  Thanks to [Chetan Nathwani](https://github.com/ChetanNathwani)
...
- **Feature**: CIPW function added to {mod}`pyrolite.mineral.normative`, largely
  from contributions by both [Chetan Nathwani](https://github.com/ChetanNathwani)
  and [Tom Buckle](https://github.com/bomtuckle) (
  [#53](https://github.com/morganjwilliams/pyrslite/issues/53)).
  ...
  An [example](https://pyrolite.readthedocs.io/en/develop/examples/geochem/CIPW.md)
...
- **Feature**: Added ternary classification plot templates
  ...
  [#49](https://github.com/morganjwilliams/pyrolite/issues/49); idea and
  implementation of the latter thanks to [Martin Bentley](https://github.com/mtb-za) !).
  The idea for implementing the ternary diagram came from a discussion with
  Jordan Lubbers and Penny Wieser (of the [Thermobar](https://thermobar.readthedocs.io/)
...
- Added autoscaling for standard {func}`~pyrolite.plot.pyroplot.spider` and
  related plots to address ([#55](https://github.com/morganjwilliams/pyrolite/issues/55))
...
- Updated {func}`~pyrolite.util.plot.helpers.init_spherical_octant` to accept
  a `fontsize` argument.
- Added [example](https://pyrolite.readthedocs.io/en/develop/examples/plotting/ternary_color.md)
...
- Moved the [manifold visualisation](https://pyrolite.readthedocs.io/en/develop/examples/util/manifold_vis.md)
...
- **Bugfix**: Fixed a bug where there scatter and line arguments would conflict for
  ...
  ([#46](https://github.com/morganjwilliams/pyrolite/issues/46)). To address this,
  ...
  [extra example](https://pyrolite.readthedocs.io/en/develop/examples/plotting/spider.md#split-configuration)
...
- Updated {func}`pyrolite.plot.color.process_color` to better handle colour mapping and
  added [examples illustrating this](https://pyrolite.readthedocs.io/en/develop/examples/plotting/spider.md#color-mapping).
...
- **Bugfix**: Fixed a bug where ratio-based normalisation was not implemented for
  ...
  ([#34](https://github.com/morganjwilliams/pyrolite/issues/34))
...
- Updated the geological timescale in {mod}`pyrolite.util.time` to use the
  ...
  ([#45](https://github.com/morganjwilliams/pyrolite/issues/45)).
...
- **Feature**: Added a [gallery](../data/index.md) of pages for each of the
  datasets included with {mod}`pyrolite`. This will soon be expanded, especially for the
  reference compositions (to address
  [#38](https://github.com/morganjwilliams/pyrolite/issues/38)).

### {mod}`pyrolite.geochem`

- **PR Merged**: [Kaarel Mand](https://github.com/kaarelmand) submitted
  [a pull request](https://github.com/morganjwilliams/pyrolite/pull/37) to add a
...
- **Feature**: Added {func}`pyrolite.geochem.ind.REY`,
  ...
  ([#35](https://github.com/morganjwilliams/pyrolite/issues/35)). This issue was
  also opened by [Kaarel Mand](https://github.com/kaarelmand)!
...
- **New Contributors**: [Kaarel Mand](https://github.com/kaarelmand) and
  [Laura Miller](https://github.com/Lauraanme)
- **PR Merged**: [Louise Schoneveld](https://github.com/lavender22) submitted
  a pull request to fill out the newly-added
  [Formatting and Cleaning Up Plots tutorial](https://pyrolite.readthedocs.io/en/develop/tutorials/plot_formatting.md).
...
- **Bugfix**: pyrolite lambdas differ slightly from [^cite_oneill2016]
  ([#39](https://github.com/morganjwilliams/pyrolite/issues/39)).
  ...
  [Laura Miller](https://github.com/Lauraanme) for this one).
  ...
  by default should give values comparable to [^cite_oneill2016]. As part of this,
  the reference composition `ChondriteREE_ON` was added to the reference database
  with the REE abundances presented in [^cite_oneill2016].
- **Bugfix**: Upgrades for {func}`~pyrolite.geochem.transform.convert_chemistry`
  to improve performance
  ([#29](https://github.com/morganjwilliams/pyrolite/issues/29)).
  ...
  [18fede0](https://github.com/morganjwilliams/pyrolite/commit/18fede01d54d06edd3fe1451409880d889e7ee62).
- **Feature**: Added the [^cite_whittakermuntus1970] ionic radii for use in silicate
  geochemistry (
  [#41](https://github.com/morganjwilliams/pyrolite/issues/41)),
  ...
  [Charles Le Losq](https://github.com/charlesll) for the suggestion!
...
[^cite_oneill2016]: O’Neill, H.S.C., 2016. The Smoothness and Shapes of Chondrite-normalized Rare Earth
    Element Patterns in Basalts. J Petrology 57, 1463–1508.
    [doi: 10.1093/petrology/egw047](https://doi.org/10.1093/petrology/egw047).

[^cite_whittakermuntus1970]: Whittaker, E.J.W., Muntus, R., 1970.
    Ionic radii for use in geochemistry.
    Geochimica et Cosmochimica Acta 34, 945–956.
    [doi: 10.1016/0016-7037(70)90077-3](<https://doi.org/10.1016/0016-7037(70)90077-3>).
...
- **Bugfix**: Added the mineral database to `MANIFEST.in` to allow this to be installed
  ...
  [Kaarel Mand](https://github.com/kaarelmand)).
...
- **Bugfix**: Updated {mod}`pyrolite.plot` to use {func}`pandas.DataFrame.reindex` over
  ...
  [#31](https://github.com/morganjwilliams/pyrolite/issues/31).
...
- **PR Merged**: [@lavender22](https://github.com/lavender22) updated the spider
...
- Added an 'Importing Data' section to the docs
  [Getting Started page](../gettingstarted.md#importing-data).
...
- Added support for spider plot index ordering added with the keyword
  {code}`index_order` ([#30](https://github.com/morganjwilliams/pyrolite/issues/30))
...
- Updated ternary plots to use {mod}`mpltern`
  ([#28](https://github.com/morganjwilliams/pyrolite/issues/28))
- Added a
  [ternary heatmap tutorial](https://pyrolite.readthedocs.io/en/develop/tutorials/ternary_density.md)
...
- Added {mod}`pyrolite.util.time`
  [example](https://pyrolite.readthedocs.io/en/develop/examples/util/timescale.md)
...
- Added [Getting Started page](../gettingstarted.md)
...
- Added [mineral database](../examples/geochem/mineral_mindb.md) and
  and [mineral endmember decomposition](../examples/geochem/mineral_endmembers.md)
  examples
...
- Updated the [normalization example](../examples/geochem/normalization.md)
...
- Added {meth}`~pyrolite.plot.pyroplot.heatscatter` and [example](../examples/plotting/heatscatter.md).
...
- Added [citation](cite.md) page to docs
- Added [contributors](contributors.md) page to docs
- Updated docs [future](future.md) page
...
- Updated [installation](installation.md) docs
...
- Added [logo example](../tutorials/logo.md)
...
[GitHub](https://github.com/morganjwilliams/pyrolite/releases) for reference,
...
[0.1.19]: https://github.com/morganjwilliams/pyrolite/compare/0.1.18...0.1.19
[0.1.2]: https://github.com/morganjwilliams/pyrolite/compare/0.1.1...0.1.2
[0.1.20]: https://github.com/morganjwilliams/pyrolite/compare/0.1.19...0.1.20
[0.1.21]: https://github.com/morganjwilliams/pyrolite/compare/0.1.20...0.1.21
...
[0.2.0]: https://github.com/morganjwilliams/pyrolite/compare/0.1.21...0.2.0
[0.2.1]: https://github.com/morganjwilliams/pyrolite/compare/0.2.0...0.2.1
[0.2.2]: https://github.com/morganjwilliams/pyrolite/compare/0.2.1...0.2.2
[0.2.3]: https://github.com/morganjwilliams/pyrolite/compare/0.2.2...0.2.3
[0.2.4]: https://github.com/morganjwilliams/pyrolite/compare/0.2.3...0.2.4
[0.2.5]: https://github.com/morganjwilliams/pyrolite/compare/0.2.4...0.2.5
[0.2.6]: https://github.com/morganjwilliams/pyrolite/compare/0.2.5...0.2.6
[0.2.7]: https://github.com/morganjwilliams/pyrolite/compare/0.2.6...0.2.7
[0.2.8]: https://github.com/morganjwilliams/pyrolite/compare/0.2.7...0.2.8
[0.3.0]: https://github.com/morganjwilliams/pyrolite/compare/0.2.8...0.3.0
[0.3.1]: https://github.com/morganjwilliams/pyrolite/compare/0.3.0...0.3.1
[0.3.2]: https://github.com/morganjwilliams/pyrolite/compare/0.3.1...0.3.2
