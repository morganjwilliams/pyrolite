...
pyrolite is available on [PyPi](https://pypi.org/project/pyrolite/), and can be downloaded with pip:
...
on [PyPi](https://pypi.org/project/pyrolite/) using the {code}`--upgrade` flag:
...
:::{seealso}
[Development Installation](./dev/development.md#development-installation)
:::
