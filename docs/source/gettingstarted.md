...
If you're new to Python [^footnote-2], or just new to {mod}`pyrolite`, checking out some of the
...
[Binder](https://mybinder.readthedocs.io/en/latest/) and
...
[^footnote-2]: If you're completely new to Python, check out some of the many free online
    ...
    [Gitter](https://gitter.im/pyrolite/community) with any questions
...
tables [^footnote-3]. Minimise unnecessary whitespace, and
...
[^footnote-3]: Where each variable is a column, and each observation is a row. If you're
    unfamiliar with the 'Tidy Data' concept, check out [^cite_wickham2014].

[^cite_wickham2014]: Wickham, H., 2014. Tidy Data.
    Journal of Statistical Software 59, 1–23.
    [doi: doi.org/10.18637/jss.v059.i10](https://doi.org/10.18637/jss.v059.i10)

## [Gitter Community](https://gitter.im/pyrolite/community)
...
See below and the [contribution](./dev/contributing.md)
and [development](./dev/development.md) guides for more information.

Note that users and contributors in online spaces (including Gitter) are expected to
adhere to the [Code of Conduct](conduct.md) of this project (and any other
